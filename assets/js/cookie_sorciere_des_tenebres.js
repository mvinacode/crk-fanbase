...
// ------------------------------
const eveilElements = document.querySelectorAll('.promotion-sorciere-cycle');
...
function setBaseForStep(step) {
  ...
  let baseSrc;
  if (step === 2 || step === 3) {
    baseSrc = "../assets/images/cookies/cookie_sorciere_des_tenebres/cookie_sorciere_des_tenebres_2_stars.webp";
  } else if (step === 4 || step === 5) {
    baseSrc = "../assets/images/cookies/cookie_sorciere_des_tenebres/cookie_sorciere_des_tenebres_4_stars.webp";
  } else if (step === 6) {
    baseSrc = "../assets/images/cookies/cookie_sorciere_des_tenebres/cookie_sorciere_des_tenebres_6_stars.webp";
  } else {
    baseSrc = "../assets/images/cookies/cookie_sorciere_des_tenebres/cookie_sorciere_des_tenebres_base.webp";
  }
