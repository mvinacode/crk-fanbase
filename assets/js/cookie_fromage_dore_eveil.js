...
const elements = document.querySelectorAll('.garniture-cycle, .costume-toggle, .biscuit-cycle, .tartelette-cycle');
...
const savedIllustration = localStorage.getItem('fromage-dore-eveil-illustration');
...
eveilElements.forEach(img => {
  ...
  img.addEventListener('click', () => {
    ...
    if (currentStep === 2) {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_dore/cookie_fromage_dore_eveil_2_stars.webp";
    } else if (currentStep === 3) {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_dore/cookie_fromage_dore_eveil_2_stars.webp";
    } else if (currentStep === 4) {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_dore/cookie_fromage_dore_eveil_4_stars.webp";
    } else if (currentStep === 5) {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_dore/cookie_fromage_dore_eveil_4_stars.webp";
    } else if (currentStep === 6) {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_dore/cookie_fromage_dore_eveil_6_stars.webp";
    } else {
      mainIllustration.src = "../assets/images/cookies/cookie_fromage_dore/cookie_fromage_dore_eveil_base.webp";
    }
    // Sauvegarde de l'illustration actuelle
    localStorage.setItem('fromage-dore-eveil-illustration', mainIllustration.src);
  });
});