...
function checkIndividualChanges() {
  const elements = document.querySelectorAll('.garniture-cycle, .biscuit-cycle, .tartelette-cycle, .promotion-cycle, .ascension-cycle, .costume-toggle, .pierre-cycle');
...
function setBaseForStep(step) {
  ...
  let baseSrc;
  if (step === 2 || step === 3) {
    baseSrc = "../assets/images/cookies/cookie_epices_ardentes/cookie_epices_ardentes_2_stars.webp";
  } else if (step === 4 || step === 5) {
    baseSrc = "../assets/images/cookies/cookie_epices_ardentes/cookie_epices_ardentes_4_stars.webp";
  } else if (step === 6) {
    baseSrc = "../assets/images/cookies/cookie_epices_ardentes/cookie_epices_ardentes_6_stars.webp";
  } else {
    baseSrc = "../assets/images/cookies/cookie_epices_ardentes/cookie_epices_ardentes_base.webp";
  }
