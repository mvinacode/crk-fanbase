...
function checkIndividualChanges() {
  const elements = document.querySelectorAll('.garniture-cycle, .bonbon-cycle, .biscuit-cycle, .tartelette-cycle, .promotion-cycle, .ascension-cycle, .costume-toggle');
...
const elements = document.querySelectorAll('.costume-toggle, .garniture-cycle, .bonbon-cycle, .ascension-cycle, .biscuit-cycle, .tartelette-cycle, .promotion-cycle');
