...
function setBaseForStep(step) {
  ...
  let baseSrc;
  if (step === 2 || step === 3) {
    baseSrc = "../assets/images/cookies/cookie_sucre_eternel/cookie_sucre_eternel_2_stars.webp";
  } else if (step === 4 || step === 5) {
    baseSrc = "../assets/images/cookies/cookie_sucre_eternel/cookie_sucre_eternel_4_stars.webp";
  } else if (step === 6) {
    baseSrc = "../assets/images/cookies/cookie_sucre_eternel/cookie_sucre_eternel_6_stars.webp";
  } else {
    baseSrc = "../assets/images/cookies/cookie_sucre_eternel/cookie_sucre_eternel_base.webp";
  }
