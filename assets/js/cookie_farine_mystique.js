...
function setBaseForStep(step) {
  ...
  let baseSrc;
  if (step === 2 || step === 3) {
    baseSrc = "../assets/images/cookies/cookie_farine_mystique/cookie_farine_mystique_2_stars.webp";
  } else if (step === 4 || step === 5) {
    baseSrc = "../assets/images/cookies/cookie_farine_mystique/cookie_farine_mystique_4_stars.webp";
  } else if (step === 6) {
    baseSrc = "../assets/images/cookies/cookie_farine_mystique/cookie_farine_mystique_6_stars.webp";
  } else {
    baseSrc = "../assets/images/cookies/cookie_farine_mystique/cookie_farine_mystique_base.webp";
  }
