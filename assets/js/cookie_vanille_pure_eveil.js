...
const savedIllustration = localStorage.getItem('vanille-eveil-illustration');
...
eveilElements.forEach(img => {
  ...
  img.addEventListener('click', () => {
    ...
    if (currentStep === 2) {
      mainIllustration.src = "../assets/images/cookies/cookie_vanille_pure/cookie_vanille_pure_eveil_2_stars.webp";
    } else if (currentStep === 3) {
      mainIllustration.src = "../assets/images/cookies/cookie_vanille_pure/cookie_vanille_pure_eveil_2_stars.webp";
    } else if (currentStep === 4) {
      mainIllustration.src = "../assets/images/cookies/cookie_vanille_pure/cookie_vanille_pure_eveil_4_stars.webp";
    } else if (currentStep === 5) {
      mainIllustration.src = "../assets/images/cookies/cookie_vanille_pure/cookie_vanille_pure_eveil_4_stars.webp";
    } else if (currentStep === 6) {
      mainIllustration.src = "../assets/images/cookies/cookie_vanille_pure/cookie_vanille_pure_eveil_6_stars.webp";
    } else {
      mainIllustration.src = "../assets/images/cookies/cookie_vanille_pure/cookie_vanille_pure_eveil_base.webp";
    }
    // Sauvegarde de l'illustration actuelle
    localStorage.setItem('vanille-eveil-illustration', mainIllustration.src);
  });
});
